...
| Nombre | Rol | Empresa |
|--------|-----|---------|
| Laura García | Tech Lead | Secture |
| Pedro Ruiz | Director Comercial | Secture |
| Carlos Mendoza | Project Manager | RetailMax |
| Ana Torres | CTO | RetailMax |
...
### 1. Estado de la Fase 2
Laura presentó el avance del primer mes de la Fase 2. Se han completado los cimientos del dashboard de analytics con los reportes básicos de ventas diarias y tráfico. La personalización de ofertas está en fase de diseño.

Carlos preguntó si el ritmo actual permite completar todos los entregables de la Fase 2 a tiempo. Laura confirmó que el burn rate está en línea: 110 horas consumidas de un presupuesto de 120h/mes, con margen para contingencias.

### 2. Revisión de Incidencias
Ana Torres mencionó que algunos clientes finales han reportado problemas con la confirmación de pedidos. Laura explicó que está relacionado con el timeout del PaymentModule contra Stripe y que es un tema de deuda técnica conocido que requiere implementar un circuit breaker. Se acordó priorizar este fix en el sprint actual.

### 3. Discusión sobre Push Notifications
Carlos solicitó que se implementen push notifications lo antes posible porque las tasas de apertura de emails de confirmación son muy bajas (solo 15%). Ana apoyó la solicitud indicando que la competencia (ShopExpress) ya ofrece notificaciones push.

Tras análisis técnico, Laura explicó que el NotificationModule está actualmente acoplado al protocolo SMTP/email y que agregar push notifications requiere un refactor significativo del módulo: crear una capa de abstracción de canales, implementar Web Push API y configurar un servicio de push (Firebase Cloud Messaging o similar).
...
Carlos mencionó que RetailMax tiene interés futuro en abrir una API para que partners (marketplaces, comparadores de precios) accedan al catálogo.
...
|---|----------|-------------|-------|
| D1 | Push notifications pospuestas a Fase 3 (Q4 2026) | Laura García | 15/01/2026 |
| D2 | NotificationModule FROZEN hasta v3.0 | Laura García | 15/01/2026 |
| D3 | Rate limiting se mantiene en 100 req/s, evaluable Q3 | Laura García | 15/01/2026 |
| D4 | Descuentos solo por porcentaje, no monto fijo | Laura García | 15/01/2026 |
| D5 | Analytics con Google Analytics 4, no plataforma propia | Carlos Mendoza | 15/01/2026 |
...
|---|-----------|-------------|--------------|
| C1 | No habrá cambios en catálogo base hasta cerrar Fase 2 | Carlos Mendoza (RetailMax) | Jun 2026 |
| C2 | Entrega del primer dashboard de analytics | Laura García (Secture) | 15 Feb 2026 |
| C3 | Propuesta comercial para Fase 3 | Pedro Ruiz (Secture) | Mar 2026 |
| C4 | Priorizar fix de timeout en PaymentModule | Laura García (Secture) | Sprint actual |
